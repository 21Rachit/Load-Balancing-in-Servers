...
public class Client  {
	...
	void sendMessage(ChatMessage msg) {
		try {
			System.out.println("inside client file "+msg);
			System.out.println("inside client file 1 "+msg.getMessage());
	...
	public static void main(String[] args) {
		...
		System.out.println("1. Simply type the message to send to the Server");
		...
		System.out.println("2. Type 'LOGOUT' without quotes to logoff from server");
